  ...
  return (
    <div className={styles.floatingContainer} aria-hidden="true">
      ...
      <div
        ...
        style={{ transform: `translate(${mousePosition.x * -0.01}px, ${mousePosition.y * 0.03}px)` }}
      />
      <div
        className={`${styles.floatingElement} ${styles.geometric1}`}
        style={{ transform: `translate(${mousePosition.x * 0.015}px, ${mousePosition.y * -0.025}px) rotate(${mousePosition.x * 0.1}deg)` }}
      />
      <div
        className={`${styles.floatingElement} ${styles.textFragment}`}
        style={{ transform: `translate(${mousePosition.x * -0.008}px, ${mousePosition.y * 0.012}px)` }}
      >
      ...
      {variant === 'radical' && (
        <div
          ...
          style={{ transform: `translate(${mousePosition.x * 0.025}px, ${mousePosition.y * 0.015}px)` }}
        />
      )}
    </div>
  )
