...
export function OptimizedImage({
  ...
  if (hasError) {
    return (
      <div className={`${styles.imagePlaceholder} ${className}`} style={{ width, height }} aria-label={alt}>
  ...
  return (
    <div ref={inViewRef} className={`${styles.imageContainer} ${className}`} style={{ width, height }}>
      {shouldLoad ? (
        ...
        <div className={styles.placeholder} style={{ width, height }} aria-label={`Loading ${alt}`} />
      )}
