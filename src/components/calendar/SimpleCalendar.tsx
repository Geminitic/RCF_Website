    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      {selectedDate && (
        <div className="mt-6 pt-6 border-t border-gray-200">
          <h3 className={`font-semibold text-gray-800 mb-3 ${currentLanguage.code === 'ar' ? 'font-arabic' : ''}`}>{t('events-on', 'Events on', 'الفعاليات في')} {selectedDate.toLocaleDateString()}</h3>
