  ...
  return (
    <div className="grid gap-8 md:grid-cols-2 mt-8">
      ...
      >
        ...
        <h3 className="text-xl font-bold text-teal-800">Volunteer with RCF</h3>
        ...
        <button type="submit" className="px-4 py-2 bg-gradient-to-r from-teal-800 via-sky-800 to-indigo-900 text-white rounded">Submit</button>
      </form>
      <form
      ...
      >
        ...
        <h3 className="text-xl font-bold text-teal-800">تطوع مع ريزوم سوريا</h3>
        ...
        <button type="submit" className="px-4 py-2 bg-gradient-to-r from-teal-800 via-sky-800 to-indigo-900 text-white rounded">إرسال</button>
      </form>
    </div>
  );
};
