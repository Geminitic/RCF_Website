...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-sky-50 to-indigo-100 pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="bg-gradient-to-br from-teal-50 via-sky-50 to-indigo-100 rounded-2xl p-8"
            >
      ...
      {/* Timeline */}
      <section className="py-20 bg-gradient-to-br from-teal-50 via-sky-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center bg-indigo-50 rounded-lg p-4">
                      ...
                      <div
                        className={`text-sm text-indigo-700 ${currentLanguage.code === 'ar' ? 'font-arabic' : ''}`}
                      >
