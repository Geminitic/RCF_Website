        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPrograms.length === 0 && (
              <p className={`col-span-full text-center text-stone-600 ${currentLanguage.code === 'ar' ? 'font-arabic' : ''}`}>
                {t('programs-coming', 'Program information will be added soon.', 'سيتم إضافة معلومات البرامج قريباً.')}
              </p>
            )}
