        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="rs-heading-1 mb-6 flex justify-center">
            ...
            <motion.p
              ...
              className="rs-heading-3 text-white/95 italic max-w-4xl mx-auto mb-8"
            >
              {t(
          ...
          >
            ...
            <ul className="grid sm:grid-cols-2 gap-4 mb-6">
              {methods.map((item, index) => (
                <li
                  key={index}
                  className="flex items-center bg-purple-50 rounded-lg p-3 shadow"
                >
            ...
            <ul className="grid sm:grid-cols-2 gap-4 mb-6">
              {goals.map((item, index) => (
                <li
                  key={index}
                  className="flex items-center bg-blue-50 rounded-lg p-3 shadow"
                >
                  <Heart className="h-5 w-5 text-blue-600 mr-3 flex-shrink-0" />
