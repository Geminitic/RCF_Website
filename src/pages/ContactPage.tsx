...
const ContactPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-sky-50 to-indigo-100 pt-16">
      {/* Hero Section */}
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="inline-flex items-center px-6 py-3 border-2 rounded-lg text-white btn-rhizome hover:filter brightness-110"
              >
              ...
              <a
                ...
                className="inline-flex items-center px-6 py-3 btn-rhizome rounded-lg"
              >
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center px-6 py-3 btn-rhizome rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
                        <motion.div
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {offices.map((office, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-teal-50 via-sky-50 to-indigo-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow"
              >
                ...
                <div className="mt-6 pt-6 border-t border-stone-200">
                  <button className="w-full flex items-center justify-center px-4 py-3 btn-rhizome rounded-lg">
